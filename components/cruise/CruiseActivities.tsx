  ...
  const activities = [
    {
      ...
      description: "Daily lectures from renowned historians focusing on African diaspora in the Caribbean",
      category: "educational",
      icon: "🎓"
    },
    {
      title: "Cultural Workshops",
      description: "Hands-on workshops exploring Caribbean arts, music, dance, and culinary traditions",
      category: "cultural",
      icon: "🎭"
    },
    {
      title: "Heritage Site Tours",
      description: "Guided excursions to significant historical sites on each island we visit",
      category: "educational",
      icon: "🏛️"
    },
    {
      title: "Panel Discussions",
      description: "Engaging discussions with experts on preservation of Black history and culture",
      category: "educational",
      icon: "💬"
    },
    {
      title: "Caribbean Dance Classes",
      description: "Learn traditional and contemporary dance styles from professional instructors",
      category: "cultural",
      icon: "💃"
    },
    {
      title: "Culinary Demonstrations",
      description: "Watch and participate in cooking demonstrations featuring traditional Caribbean cuisine",
      category: "dining",
      icon: "👨‍🍳"
    },
    {
      title: "Poolside Relaxation",
      description: "Enjoy our luxury pools, hot tubs, and sundecks with Caribbean views",
      category: "leisure",
      icon: "🏊"
    },
    {
      title: "Evening Entertainment",
      description: "Nightly shows featuring music, dance, and performances celebrating Black culture",
      category: "cultural",
      icon: "🎺"
    },
    {
      title: "Spa & Wellness",
      description: "Rejuvenate with spa treatments inspired by traditional Caribbean healing practices",
      category: "leisure",
      icon: "💆"
    },
    {
      title: "Fitness Classes",
      description: "Stay active with daily fitness classes including yoga, Caribbean cardio, and more",
      category: "leisure",
      icon: "🧘"
    },
    {
      title: "Film Screenings",
      description: "Watch documentaries and films about Black history and the Caribbean experience",
      category: "educational",
      icon: "🎬"
    },
    {
      title: "Gourmet Dining",
      description: "Experience themed dinner nights featuring cuisine from different Caribbean islands",
      category: "dining",
      icon: "🍽️"
    }
  ];
          ...
          {filteredActivities.map((activity, index) => (
            ...
            >
              <div className="p-6">
                ...
                <p className="font-helvetica text-secondary">{activity.description}</p>
                
                <div className="mt-4 pt-2 border-t border-blue-100">
                  <span className="inline-block px-3 py-1 bg-primary bg-opacity-10 text-primary rounded-full text-sm font-helvetica font-medium capitalize">
                    {activity.category}
                  </span>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 md:p-12">
                ...
                <p className="font-helvetica text-white opacity-90 mb-6">
                  Each evening of our cruise features special themed events showcasing different aspects of Black Caribbean heritage through music, dance, food, and storytelling.
                </p>
              ...
              <div className="bg-gradient-to-br from-primary to-primary-dark h-64 lg:h-auto">
                <div className="h-full w-full flex items-center justify-center p-8">
                  <img 
                    src="/images/cruise-event.jpg" 
                    alt="Evening performance"
                    className="h-full w-full object-cover rounded-lg"
                    onError={(e) => {
                      e.currentTarget.src = "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?q=80&w=1169";
                    }}
                  />
                </div>
              </div>
