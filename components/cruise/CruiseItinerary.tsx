  ...
  const itineraryData = [
    {
      ...
      title: "Embarkation",
      description: "Begin your journey in Miami with a special embarkation ceremony. Settle into your cabin and join us for a welcome reception featuring keynote speakers discussing the historical significance of our voyage.",
      activities: [
    ...
    },
    {
      ...
      description: "Our first full day at sea features a series of workshops, lectures, and panel discussions from renowned historians and cultural experts focusing on the African influences in Caribbean culture.",
      activities: [
    ...
    },
    {
      ...
      description: "Explore Nassau's rich history with guided tours focusing on the role of the Bahamas in the abolition movement and as a haven for freed enslaved people. Visit key historical sites and engage with local historians.",
      activities: [
    ...
    },
    {
      ...
      description: "Experience the vibrant Afro-Caribbean culture of Puerto Rico through tours of historic sites, cultural demonstrations, and immersive experiences showcasing the island's African heritage.",
      activities: [
    ...
    },
    {
      ...
      description: "Discover the profound history of Haiti, the first Black republic established through revolution. Visit significant sites related to the Haitian Revolution and learn about the nation's impact on global Black liberation movements.",
      activities: [
    ...
    },
    {
      ...
      description: "Explore Jamaica's history of resistance and resilience, from Maroon communities to the development of Rastafarianism. Experience the island's rich cultural traditions and their connections to African heritage.",
      activities: [
    ...
    },
    {
      ...
      description: "Our final day at sea is dedicated to reflection, discussion, and celebration. Participate in workshops to process the experiences of the week and join our gala dinner celebrating the richness of Black history and culture.",
      activities: [
          ...
          <div className="flex overflow-x-auto scrollbar-hide bg-gray-50 border-b border-gray-200">
            {itineraryData.map((day, index) => (
              <button
                ...
                className={`px-6 py-4 text-left flex-shrink-0 focus:outline-none transition-colors duration-300 ${
                  activeTab === index 
              ...
              >
                ...
                <p className="font-helvetica text-sm opacity-80">{day.location}</p>
              </button>
            ))}
          </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2">
                    ...
                    <ul className="space-y-2">
                      {itineraryData[activeTab].activities.map((activity, i) => (
                        <li key={i} className="flex items-start">
                          <svg className="h-5 w-5 mt-1 mr-2 text-secondary" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div className="bg-ocean rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="font-helvetica text-sm text-secondary">Full Day</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="font-helvetica text-sm text-secondary">{itineraryData[activeTab].location}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="font-helvetica text-sm text-secondary">Local Historian & TBHF Expert</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="font-helvetica text-sm text-secondary">All meals, transportation & activities</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-200">
                      <p className="font-helvetica text-sm text-navy opacity-75">
                        Note: Itinerary subject to change based on weather conditions and local circumstances. All efforts will be made to maintain the educational and cultural integrity of the experience.
                      </p>
                    </div>
                  </div>
                </div>
