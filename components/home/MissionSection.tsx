            ...
            <div className="relative">
              ...
              >
                ...
                <p className="font-helvetica text-sm">
                  Help us digitize documents, restore landmarks, and fund
                  educational programs that keep Black history alive.
                </p>
              </motion.div>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection className="order-1 lg:order-2" direction="left">
            ...
            <div className="space-y-6 mt-8">
              <div className="flex">
                <div className="flex-shrink-0 mr-4">
                  <div className="h-12 w-12 rounded-full bg-[var(--secondary)] flex items-center justify-center">
                    <svg
                      ...
                      className="h-6 w-6 text-[var(--accent-black)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <div>
                  <h3 className="font-neue-kabel font-bold text-xl mb-1">
                    Digitize and Preserve
                  </h3>
                  <p className="font-helvetica text-[var(--text-secondary)]">
                    We're using advanced technology to digitize and preserve
                    historical documents, photographs, and artifacts for future
                    generations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="font-helvetica text-[var(--text-secondary)]">
                    We work to restore and protect historical landmarks and
                    sites significant to Black history across the country.
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="font-helvetica text-[var(--text-secondary)]">
                    We develop educational programs and resources to ensure
                    Black history is accurately taught and integrated into
