    ...
    <section ref={ref} className="py-16 md:py-24 bg-[var(--bg-secondary)]">
      <div className="container mx-auto px-4 sm:px-6">
        <SectionHeading
          ...
          description="Find answers to commonly asked questions about our mission, donation process, and how you can get involved."
          centered
        />
        ...
        <div className="max-w-3xl mx-auto mt-12">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span className="font-neue-kabel font-bold text-lg">{faq.question}</span>
                <svg
