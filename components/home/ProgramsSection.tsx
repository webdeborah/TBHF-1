...
const ProgramsSection = () => {
  ...
  const programs = [
    ...
    },
    {
      ...
      description: "Digital archives, AI-powered preservation tools, blockchain-based platform for historical records, and virtual reality experiences.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Historical site restoration, artifact preservation and digitization, archival projects, and oral history documentation.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
