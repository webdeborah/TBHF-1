        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <AnimatedSection>
            <div className="relative">
              ...
              >
                <h3 className="font-neue-kabel font-bold text-xl mb-2 text-[var(--secondary)]">Our Values</h3>
                <ul className="font-helvetica text-sm space-y-2">
                  <li className="flex items-center">
                    <span className="mr-2 text-[var(--secondary)]">✓</span> Education
                  </li>
                  <li className="flex items-center">
                    <span className="mr-2 text-[var(--secondary)]">✓</span> Community
                  </li>
                  <li className="flex items-center">
                    <span className="mr-2 text-[var(--secondary)]">✓</span> Innovation
                  </li>
                  <li className="flex items-center">
                    <span className="mr-2 text-[var(--secondary)]">✓</span> Cultural Heritage
                  </li>
                </ul>
              </motion.div>
            </div>
          ...
          <AnimatedSection direction="left">
            <div className="lg:pl-8">
              <span className="font-neue-kabel uppercase text-sm tracking-wider text-[var(--primary)]">Who We Are</span>
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  <h3 className="font-neue-kabel font-bold text-2xl text-[var(--accent-black)]">Mission</h3>
                ...
                <div className="space-y-4">
                  <h3 className="font-neue-kabel font-bold text-2xl text-[var(--accent-black)]">Vision</h3>
                  <p className="font-helvetica text-[var(--text-secondary)] leading-relaxed">
                ...
                <div className="space-y-4">
                  <h3 className="font-neue-kabel font-bold text-2xl text-[var(--accent-black)]">Our Approach</h3>
                  <p className="font-helvetica text-[var(--text-secondary)] leading-relaxed">
                ...
                <div className="md:hidden space-y-4">
                  <h3 className="font-neue-kabel font-bold text-2xl text-[var(--accent-black)]">Our Values</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-[var(--bg-secondary)] p-4 rounded-lg">
                      <span className="text-[var(--primary)] font-bold">Education</span>
                    </div>
                    <div className="bg-[var(--bg-secondary)] p-4 rounded-lg">
                      <span className="text-[var(--primary)] font-bold">Community</span>
                    </div>
                    <div className="bg-[var(--bg-secondary)] p-4 rounded-lg">
                      <span className="text-[var(--primary)] font-bold">Innovation</span>
                    </div>
                    <div className="bg-[var(--bg-secondary)] p-4 rounded-lg">
                      <span className="text-[var(--primary)] font-bold">Cultural Heritage</span>
                    </div>
                  </div>
                </div>
              </div>
