...
const DonateImpact = () => {
  ...
  const impactItems = [
    {
      amount: "$25",
      description: "Helps digitize 50 historical documents or photographs, preserving them for future generations.",
      icon: (
    ...
    {
      amount: "$50",
      description: "Provides educational materials about Black history to a classroom of students.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      amount: "$100",
      description: "Supports one community workshop or event focused on preserving local Black history.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      amount: "$250",
      description: "Helps restore a historic document or artifact in need of preservation.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      amount: "$500",
      description: "Funds a teacher training workshop on effectively teaching Black history in schools.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      amount: "$1,000",
      description: "Supports the development of a digital archive or oral history collection project.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
